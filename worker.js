...
/* =========================================================
   CONTRASEÑAS
   IMPORTANTE:
   Cloudflare Workers no acepta 120000.
   Máximo compatible: 100000.
========================================================= */
...
export default {
  ...
  async fetch(
    ...
    try {
      ...
      /*
       * Preparamos las tablas y columnas
       * necesarias.
       */
